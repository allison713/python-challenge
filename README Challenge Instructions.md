...
* The total number of months included in the dataset (month_counter)

* The net total amount of "Profit/Losses" over the entire period (net_total_profit)

* The changes in "Profit/Losses" over the entire period, and then the average of those changes (average_profit_changes)

* The greatest increase in profits (date and amount) over the entire period (max_profit)

* The greatest decrease in profits (date and amount) over the entire period (min_profit)
